const rp = require('request-promise');
 ...
 const HttpReq = async (body) => {
    ...
    var options = {
        url: 'https://ziv-service.herokuapp.com/',
        body,
        // protocol:'http:',
        json: true,
        headers: {
...
// create a map
var map = L.map('map').setView([31.2578, 34.7948], 13);
...
var req_resp = HttpReq()
req_resp.then(function(v,e) {
    console.log("e",e);
console.log("v",v);
